...
function live_countdown_timer_form() {
    if ($_POST['live_countdown_timer_Title']) {
        ...
        $live_countdown_timer_Title = $xPostArr[0];
...
?>
    ...
    <div class="xLCTFullWidth">
        ...
        <div class="xAdminDiv">
            ...
            ?>
                    <option value="<?php echo $xTZName; ?>" <?php
                    if ($postTimeZone == $xTZName) {
                        echo " selected ";
                    } ?>><?php echo $xTZName; ?></option>
                    <?php
                }
            } catch (MyException $e) {
                    ?>
            <option value="America/Chicago">Timezones requires PHP 5.x Please upgrade. Default Timezone is America/Chicago</option>
            <?php
            }
            ?>
    ...
    <div class="xAdminDiv">
        ...
        <select name="live_countdown_timer_TimerType" id="live_countdown_timer_TimerType" >
            <option value="1" <?php
                ...
                ?>>Original - D:H:M:S above LCT(Default)</option>
            <option value="2" <?php
                    if ($postTimerType == "2") {
                        echo " selected ";
                    }
                ?>>Original - D:H:M:S under LCT</option>
            <option value="3" <?php
                    if ($postTimerType == "3") {
                        echo " selected ";
                    } ?>>Plain Text - D:H:M:S next to LCT</option>
            <option value="4" <?php
                    if ($postTimerType == "4") {
                        echo " selected ";
                    }
...
?>
    ...
    <h2 class="xCustomCSSB">Embed Code:</h2><br/><input type="text" readonly value="[LCT-|-embed]" /><br/>this code will be replaced with the timer <b>(you must add this code anywhere in your post for the timer to show)</b>
