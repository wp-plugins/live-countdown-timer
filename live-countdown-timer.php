...
<div id="xLCTReturn">
    ...
    <h2 class="xCustomCSSB">Embed Code:</h2><br/><input type="text" readonly value="[LCT-|-embed]" />this code will be replaced with the timer (copy/paste this code anywhere in your post)
